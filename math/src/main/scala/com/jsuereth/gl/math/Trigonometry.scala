...
def sin[T](value: T)(using t: Trigonometry[T]): T = t.sin(value)
/** Accepts a value in radians and returns the cosine. */
def cos[T](value: T)(using t: Trigonometry[T]): T = t.cos(value)
/** Accepts a value in radians and returns the tangent. */
def tan[T](value: T)(using t: Trigonometry[T]): T = t.tan(value)
/** Converts from Degrees to Radians for a given type. */
def angleToRadians[T](value: T)(using t: Trigonometry[T]): T = t.angleToRadians(value)
